        ...
        <div className="max-w-[900px] mx-auto rounded-3xl flex flex-col md:flex-row overflow-hidden shadow-[0_40px_100px_rgba(0,0,0,0.5)]">
          ...
          <div className="flex-1 bg-background text-foreground p-10 md:p-16 text-center border-l border-border">
            ...
            <a
              ...
              className="inline-block bg-gradient-to-br from-primary to-[#f1d592] text-primary-foreground py-5 px-10 rounded-lg font-extrabold text-base uppercase w-full shadow-[0_10px_30px_rgba(212,175,55,0.2)] hover:-translate-y-1 hover:shadow-[0_15px_50px_rgba(212,175,55,0.4)] transition-transform no-underline text-center"
              target="_blank"
